package com.netease.cloud.nsf.demo.util;
...
public class NsfExceptionUtil {
    ...
    public static class NsfExceptionWrapper{
        ...
        public NsfExceptionType getType() {
            return type;
        }
    ...
    public static NsfExceptionWrapper parseException(Exception e) {
